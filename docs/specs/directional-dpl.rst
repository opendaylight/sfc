...
It is worth mentioning that the proposed change may not enough to fully
support legacy 'bump in the wire' network devices  that are sfc unaware
acting as service functions. For this, it might be additionally needed
to:
