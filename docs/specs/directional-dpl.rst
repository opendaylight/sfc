...
Use Cases
---------
Support directional data plane locators
...
appropriate data plane locator pair based on the direction.
...
requested to genius for the interface provided by the openflow
processor.
...
while operating in this mode, allow to use already supported mechanisms
(mac chaining, nsh...) to steer SFC traffic.
