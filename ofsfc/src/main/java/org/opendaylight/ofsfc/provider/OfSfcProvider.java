...
public class OfSfcProvider implements AutoCloseable {


    private static final Logger LOG = LoggerFactory.getLogger(OfSfcProvider.class);
    ...
    private static OfSfcProvider opendaylightSfcObj;

    private Future<RpcResult<Void>> currentTask;

    public OfSfcProvider() {
    ...
    public static OfSfcProvider getOpendaylightSfcObj () {
        return OfSfcProvider.opendaylightSfcObj;
    }
