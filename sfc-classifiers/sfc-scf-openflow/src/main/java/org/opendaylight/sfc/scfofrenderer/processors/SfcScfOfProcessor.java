...
public class SfcScfOfProcessor {
    ...
    /**
     * create flows for service function classifier The function returns true if
     * successful. The function returns false if unsuccessful.
     *
     * @param scf
    ...
    /**
     * delete flows for service function classifier The function returns true if
     * successful. The function returns false if unsuccessful.
     *
     * @param scf
     *            service function classifier
    ...
    public boolean deletedServiceFunctionClassifier(ServiceFunctionClassifier scf) {
        ...
        // so that we delete the initialization flows from SFFs that do not
        // belong to any RSPs
