...
public class ClassifierHandler {
     ...
     *
     * @param theClassifier
     *            the classifier from which we want the InterfaceName
     ...
     *
     * @param nodeName
     *            the node from which the flow will be deleted
     * @param flowKey
     *            the key of the flow we want to delete
     * @param tableID
     *            the table from which we want to delete the flow
     ...
     *
     * @param nodeName
     *            the node in which the flow will be installed
     * @param flow
     *            the flow to install
     * @param rspId
     *            the RSP path ID to which the flow belongs to
     * @return the {@link FlowDetails} object that identifies the desired flow
     */
     ...
     *
     * @param theSff
     *            the {@link ServiceFunctionForwarder} to which the classifier
     *            is connected to
