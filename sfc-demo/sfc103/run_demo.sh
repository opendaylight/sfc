...
function start_sfc {
    ...
    sed -i "/^featuresBoot[ ]*=/ s/$/,odl-sfc-model,odl-sfc-provider-rest,odl-sfc-openflow-renderer,odl-sfc-scf-openflow,odl-sfc-ovs/" etc/org.apache.karaf.features.cfg;
