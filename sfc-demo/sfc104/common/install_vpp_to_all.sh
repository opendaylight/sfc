...
vagrant ssh ${SFF1_NAME} -c "sudo /vagrant/common/install_vpp.sh ${HTTPPROXY} ${HTTPSPROXY}"
...
vagrant ssh ${SFF2_NAME} -c "sudo /vagrant/common/install_vpp.sh ${HTTPPROXY} ${HTTPSPROXY}"
...
vagrant ssh ${CLASSIFIER2_NAME} -c "sudo /vagrant/common/install_vpp.sh ${HTTPPROXY} ${HTTPSPROXY}"
