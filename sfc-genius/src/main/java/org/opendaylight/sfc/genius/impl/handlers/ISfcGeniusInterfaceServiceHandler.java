 ...
 * locators. When such service functions are included in a rendered service path
 * and to be able to steer traffic towards them, certain actions need to be
 * taken in regards to these logical interfaces, referred to as binding SFC
 * service to the interface.
 *
 * <p>
...
public interface ISfcGeniusInterfaceServiceHandler {
     ...
     *            the name of the interface
     * @param dpnId
     *            the data plane id of the old node associated to the interface
     */
