...
public class SfcGeniusBoundServiceWriter {
    ...
    public CompletableFuture<Void> bindService(String interfaceName) {
        InstanceIdentifier<BoundServices> id = InstanceIdentifier.builder(ServiceBindings.class)
                ...
                .child(BoundServices.class, new BoundServicesKey(SfcGeniusConstants.SFC_SERVICE_INDEX))
                .build();
        short offset = SfcGeniusConstants.SFC_TRANSPORT_INGRESS_TABLE;
        ...
        BoundServices boundServices = new BoundServicesBuilder()
                .setServiceName(SfcGeniusConstants.SFC_SERVICE_NAME)
                .setServicePriority(SfcGeniusConstants.SFC_SERVICE_INDEX)
