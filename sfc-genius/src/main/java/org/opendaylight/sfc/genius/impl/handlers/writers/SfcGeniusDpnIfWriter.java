 ...
 * mapping information is represented as a {@link Map} where each key is a data
 * plane node identifier and each value is a {@link Set} of the interface names
 * located on the such data plane node.
 */
public class SfcGeniusDpnIfWriter {
    ...
    /**
     * Constructs a {@code SfcGeniusDpnIfWriter} using the provided {@link Map}.
     *
     * @param dpnInterfaces
     *            the {@link Map} of data planes to interfaces to be handled by
     *            this {@code SfcGeniusDpnIfWriter}.
     */
     ...
     *
     * @param dpnId
     *            the data plane node identifier to add the interface to.
     * @param interfaceName
     *            the name of the interface to add.
     *
     * @return Optionally, the data plane node identifier that was also added
     *         because it was associated for the first time with an interface.
     */
     ...
     *
     * @param dpnId
     *            the data plane node identifier to remove the interface from.
     * @param interfaceName
     *            the name of the interface to remove.
     *
     * @return Optionally, the data plane node identifier that was also removed
     *         because it was no longer associated to any interface.
     */
    public CompletableFuture<Optional<BigInteger>> removeInterfaceFromDpn(BigInteger dpnId, String interfaceName) {
        ...
        return interfaces == null ? CompletableFuture.completedFuture(Optional.of(dpnId))
                : CompletableFuture.completedFuture(Optional.empty());
    }
}
