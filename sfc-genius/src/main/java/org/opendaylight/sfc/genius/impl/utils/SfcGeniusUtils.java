...
public class SfcGeniusUtils {
     ...
     * @param executor the executor where the callback execution is submitted.
     * @param <T> the type of the listenable future.
     ...
     * @throws SfcGeniusRuntimeException wrapping an
     * {@link IllegalArgumentException} if the input list does not contain one
     * item only, or if the format of the item is invalid.
     */
