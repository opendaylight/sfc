...
public class SfcTableIndexMapperBuilder {
    ...
    public static final short EXTERNAL_TABLE_NOT_SETTED = -1;
    private short externalTransportIngressTable = EXTERNAL_TABLE_NOT_SETTED;
    private short externalPathMapperTable = EXTERNAL_TABLE_NOT_SETTED;
    private short externalPathMapperAclTable = EXTERNAL_TABLE_NOT_SETTED;
    private short externalNextHopTable = EXTERNAL_TABLE_NOT_SETTED;
    private short externalTransportEgressTable = EXTERNAL_TABLE_NOT_SETTED;
