...
public class SfcGeniusBoundServiceWriterTest {
    ...
    public void bindService() throws Exception {
        ...
        assertThat(boundServices.getServiceName(), is(SfcGeniusConstants.SFC_SERVICE_NAME));
        assertThat(boundServices.getServicePriority(), is(SfcGeniusConstants.SFC_SERVICE_INDEX));
