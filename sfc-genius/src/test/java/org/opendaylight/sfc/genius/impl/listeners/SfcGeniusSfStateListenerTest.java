...
public class SfcGeniusSfStateListenerTest {
    ...
    @Mock
    ISfcGeniusInterfaceServiceHandler geniusInterfaceServiceHandler;
    ...
    @Before
    public void setup() {
        sfcGeniusSfStateListener = new SfcGeniusSfStateListener(geniusInterfaceServiceHandler, executor);
    }
    ...
    public void remove() throws Exception {
        ...
        verify(geniusInterfaceServiceHandler).unbindInterfacesOfServiceFunction("SF1");
    }
    ...
    public void removeNoPaths() throws Exception {
        ...
        verifyZeroInteractions(geniusInterfaceServiceHandler);
    }
    ...
    public void updateMorePaths() throws Exception {
        ...
        verify(executor).execute(runnableCaptor.capture());
        runnableCaptor.getValue().run();
        verify(geniusInterfaceServiceHandler).bindInterfacesOfServiceFunction("SF1");
    }
