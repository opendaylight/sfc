...
public class SfcGeniusDatastoreApiTest {
    ...
    public void getSfLogicalInterfaceNegativeTestNoDpl() {
        ...
        Assert.assertFalse(SfcGeniusDatastoreApi.getSfLogicalInterface(dpiNode).isPresent());
    }
    ...
    public void getSfLogicalInterface() {
        ...
        Assert.assertTrue(SfcGeniusDatastoreApi.getSfLogicalInterface(dpiNode).isPresent());
        Assert.assertEquals("40c552e0-3695-472d-bace-7618786aba27",
                SfcGeniusDatastoreApi.getSfLogicalInterface(dpiNode).get());
    }
}
