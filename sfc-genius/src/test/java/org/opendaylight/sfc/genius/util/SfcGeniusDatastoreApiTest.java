...
/**
* Unit Testing for the Mac Retrieval function within the SfcGeniusUtils class.
*
...
public class SfcGeniusDatastoreApiTest {
    private static final Logger LOG = LoggerFactory.getLogger(SfcGeniusDatastoreApiTest.class);

    private String ifName = "40c552e0-3695-472d-bace-7618786aba27";
    private String macAddress = "b2:0e:19:ad:1e:22";
    private String theDpnId = "79268612506848";
    private String logicalIfName = "tap40c552e0-36";
    private String ovsdbNodeId = "ovsdb://uuid/e94d439a-57cf-4b8f-9247-56cdd692fa33/bridge/br-int";
    private ServiceFunction dpiNode;

    @Captor
    ArgumentCaptor<Interface> interfaceCaptor;

    public SfcGeniusDatastoreApiTest() {
        ...
        dpiNode = new ServiceFunctionBuilder()
                        .setKey(dpiKey)
    ...
    @Before
    public void setUp() {
        LOG.info("SfcGeniusDatastoreApiTest before()");
        ...
        BridgeRefEntry theBridge = new BridgeRefEntryBuilder()
                .setKey(new BridgeRefEntryKey(new BigInteger(theDpnId)))
        ...
        PowerMockito.when(SfcGeniusUtilsDataGetter.getBridgeFromDpnId(anyString())).thenReturn(theBridge);
    }
    ...
    public void readMacAddressInterfaceDoesNotExist() {
        ...
        SfcGeniusDatastoreApi.getServiceFunctionMacAddress(ifName);
    }
    ...
    public void readMacAddress() {
        Assert.assertNotNull(SfcGeniusDatastoreApi.getServiceFunctionMacAddress(ifName));
        Assert.assertEquals(macAddress, SfcGeniusDatastoreApi.getServiceFunctionMacAddress(ifName).getValue());
    }
    ...
    public void getSfLogicalInterfaceNegativeTestNoDpl() {
        ...
        SfcGeniusDatastoreApi.getSfLogicalInterface(dpiNode);
    }
    ...
    public void getSfLogicalInterface() {
        ...
        Assert.assertEquals("40c552e0-3695-472d-bace-7618786aba27",
                SfcGeniusDatastoreApi.getSfLogicalInterface(dpiNode));
        Assert.assertTrue(SfcGeniusDatastoreApi.isSfUsingALogicalInterface(dpiNode));
    }

    @Test
    public void isSfUsingALogicalInterfaceNegative() {
        Assert.assertFalse(SfcGeniusDatastoreApi.isSfUsingALogicalInterface(dpiNode));
    }

    @Test
    public void isSfUsingALogicalInterfacePositive() {
        Assert.assertFalse(SfcGeniusDatastoreApi.isSfUsingALogicalInterface(dpiNode));
    }
}
