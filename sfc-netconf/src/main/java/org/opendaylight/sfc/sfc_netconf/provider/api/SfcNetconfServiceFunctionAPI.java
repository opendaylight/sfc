...
import org.opendaylight.yang.gen.v1.urn.cisco.params.xml.ns.yang.sfc.sl.rev140701.TransportType;
...
public class SfcNetconfServiceFunctionAPI {
    ...
    public static org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunction createFunction(
            ServiceFunction function) {
        SfName sfName = function.getName();

        IpAddress sfDplIpAddress = getIpAddressFromSfDpl(function.getSfDataPlaneLocator());
        ...
        if (sfDplIpAddress != null && sfDplIpAddress.getIpv4Address() != null) {
            ...
            // Description
            String description = "Service function"  + function.getName().getValue() + " type: "
                    + function.getType().getValue();
            // Encapsulation
            // TODO use all locators
            SfDataPlaneLocator sfDataPlaneLocator = function.getSfDataPlaneLocator().get(0);
            ...
            if (transport == org.opendaylight.yang.gen.v1.urn.cisco.params.xml.ns.yang.sfc.sl.rev140701.Gre.class) {
                ...
                encapsulationBuilder.setGre(new GreBuilder().build());
                ...
                sfModeBuilder.setIp(ipBuilder.build())
                        ...
                        .setEncapsulation(encapsulationBuilder.build());
    ...
    public static InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunction> createSfIid(
            ServiceFunctionKey key) {
        return InstanceIdentifier.builder(Native.class)
                .child(ServiceChain.class)
                .child(org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunction.class, key)
                .build();
    }

    public static IpAddress getIpAddressFromSfDpl(List<SfDataPlaneLocator> dataPlaneLocators) {
...
//            PortNumber portNumber, SftType type) {
