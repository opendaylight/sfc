...
public class SfcNetconfUtils {
     ...
     * @return service function forwarder object for netconf device which contains {@link Local} SFF. Null if parameter
    ...
    /**
     * Creates remote service function forwarder (netconf SFC entity) {@link ServiceFfName}. Using name of the original
     ...
     * @return remote SFF (netconf SFC entity), null if SFF does not contain data plane locator with IP locator type
     */
     ...
     * Every netconf device can contain just one local SFF, that means there is one Local SFF for mountpoint
     *
     ...
     */
    static InstanceIdentifier<ServiceFfName> createRemoteSffIid(ServiceFfName sffName) {
        return InstanceIdentifier.builder(Native.class)
                .child(ServiceChain.class)
                .child(org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunctionForwarder.class)
     ...
     * @return IID of the remote SFF
     */
    static InstanceIdentifier<ServiceFfName> createRemoteSffIid(SffName sffName) {
        return InstanceIdentifier.builder(Native.class)
                .child(ServiceChain.class)
                .child(org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunctionForwarder.class)
     ...
     */
    static InstanceIdentifier<ServiceFunction> createSfIid(ServiceFunctionKey key) {
        return InstanceIdentifier.builder(Native.class)
                .child(ServiceChain.class)
     ...
     */
    static InstanceIdentifier<ServicePath> createServicePathIid(ServicePathKey key) {
        return InstanceIdentifier.builder(Native.class)
                .child(ServiceChain.class)
