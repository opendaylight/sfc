...
public class ServiceForwarderListener implements DataTreeChangeListener<ServiceFunctionForwarders> {
    ...
    private final ListenerRegistration netconfSffListenerRegistration;
    private final NetconfServiceForwarderMapper sffManager;

    public ServiceForwarderListener(DataBroker dataBroker, NetconfServiceForwarderMapper sffManager) {
