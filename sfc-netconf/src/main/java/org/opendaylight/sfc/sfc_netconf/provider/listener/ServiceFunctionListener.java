...
public class ServiceFunctionListener implements DataTreeChangeListener<ServiceFunctions> {
    ...
    private final NetconfServiceFunctionMapper sfManager;
    private final ListenerRegistration netconfSfListenerRegistration;

    public ServiceFunctionListener(DataBroker dataBroker, NetconfServiceFunctionMapper sfManager) {
