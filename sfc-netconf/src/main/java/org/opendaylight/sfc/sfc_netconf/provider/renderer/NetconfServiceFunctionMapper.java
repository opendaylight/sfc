...
import org.opendaylight.sfc.sfc_netconf.provider.listener.ServiceFunctionListener;
...
import static org.opendaylight.sfc.sfc_netconf.provider.api.NetconfDataStoreAPI.Transaction.DELETE_FUNCTION;
import static org.opendaylight.sfc.sfc_netconf.provider.api.NetconfDataStoreAPI.Transaction.WRITE_FUNCTION;


public class NetconfServiceFunctionMapper {

    private static final Logger LOG = LoggerFactory.getLogger(NetconfServiceFunctionMapper.class);

    private final NodeManager nodeManager;
    private final ServiceFunctionListener sfListener;

    public NetconfServiceFunctionMapper(DataBroker dataBroker, NodeManager nodeManager) {
                ...
                if (netconfNodeIp.equals(forwarderMgmtIp)) {
                    ...
                    if (mountPoint != null && !delete) {
                        ...
                        if (serviceFunction != null) {
                            new NetconfDataStoreAPI(mountPoint, serviceFunction, WRITE_FUNCTION).call();
                    ...
                    if (mountPoint != null && delete) {
                        org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunction serviceFunction =
                                createNetconfServiceFunction(function);
                        if (serviceFunction != null) {
                            new NetconfDataStoreAPI(mountPoint, serviceFunction.getKey(), DELETE_FUNCTION).call();
    ...
    private org.opendaylight.yang.gen.v1.urn.ios.rev160308._native.service.chain.ServiceFunction createNetconfServiceFunction(
        ...
        SfDataPlaneLocator sfDataPlaneLocator = SfcNetconfUtils.getDplWithIpLocatorType(function
