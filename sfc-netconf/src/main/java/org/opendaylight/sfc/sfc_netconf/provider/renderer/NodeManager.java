...
import org.opendaylight.sfc.sfc_netconf.provider.listener.NodeListener;
...
public class NodeManager {
    ...
    private final SfcNetconfDataProvider dataProvider;
    ...
    public NodeManager(DataBroker dataBroker, BindingAwareBroker bindingAwareBroker) {
        // Register provider
        dataProvider = SfcNetconfDataProvider.GetNetconfDataProvider();
