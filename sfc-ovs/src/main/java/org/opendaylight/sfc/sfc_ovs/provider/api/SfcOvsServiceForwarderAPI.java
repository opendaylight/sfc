...
public class SfcOvsServiceForwarderAPI {
    ...
    public static ServiceFunctionForwarder buildServiceForwarderFromOvsdbBridge(OvsdbManagedNodeAugmentation ovsdbManagedNodeAugmentation) {
        Preconditions.checkNotNull(ovsdbManagedNodeAugmentation);

        OvsdbBridgeName bridgeName = ovsdbManagedNodeAugmentation.getBridgeName();
        Uuid uuid = ovsdbManagedNodeAugmentation.getBridgeUuid();
    ...
    public static String getServiceForwarderNameFromOvsdbBridge(OvsdbManagedNodeAugmentation ovsdbManagedNodeAugmentation) {
        Preconditions.checkNotNull(ovsdbManagedNodeAugmentation);
