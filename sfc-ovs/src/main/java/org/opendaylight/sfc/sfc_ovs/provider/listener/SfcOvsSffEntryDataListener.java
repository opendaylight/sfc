        ...
        for (Map.Entry<InstanceIdentifier<?>, DataObject> entry : dataCreatedObject.entrySet()) {
            ...
            if (entry.getValue() instanceof ServiceFunctionForwarder) {
                ...
                List<OvsdbBridgeAugmentation> ovsdbBridgeList =
                        SfcOvsServiceForwarderAPI.getOvsdbBridgeListFromServiceForwarder(serviceFunctionForwarder);

                for (OvsdbBridgeAugmentation ovsdbBridge : ovsdbBridgeList) {
                    SfcOvsServiceForwarderAPI.putOvsdbBridgeAugmentation(ovsdbBridge);
                }
