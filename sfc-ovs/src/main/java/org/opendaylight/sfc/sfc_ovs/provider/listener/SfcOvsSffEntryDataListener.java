...
public class SfcOvsSffEntryDataListener extends SfcOvsAbstractDataListener {
    ...
    public SfcOvsSffEntryDataListener(DataBroker db, ExecutorService executor) {
    ...
    public void onDataChanged(final AsyncDataChangeEvent<InstanceIdentifier<?>, DataObject> change) {
        ...
        for (Map.Entry<InstanceIdentifier<?>, DataObject> entry : dataCreatedObject.entrySet()) {
            ...
            if (entry.getValue() instanceof ServiceFunctionForwarder) {
                ...
                addOvsdbAugmentations(serviceFunctionForwarder, getExecutorService());
            }
        }
        ...
        for (Map.Entry<InstanceIdentifier<?>, DataObject> entry : dataUpdatedObject.entrySet()) {
            if ((entry.getValue() instanceof ServiceFunctionForwarder)
                ...
                addOvsdbAugmentations(updatedServiceFunctionForwarder, getExecutorService());
            }
        }
