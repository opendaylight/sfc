...
public class SfcSffToOvsMappingAPITest {
    ...
    @Test
    public void buildTerminationPointAugmentationListTest() throws Exception {
    ...
    @Test
    public void buildVxlanTunnelDataPlaneLocatorTestWhereIpV4AddressIsNull() throws Exception {
