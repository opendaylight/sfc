...
public class SfcPotRspProcessor {
     ...
     */
    public static boolean enableSfcPot  (RenderedServicePath rsp, RspName rspName,
        ...
        sfp = SfcProviderServicePathAPI.readServiceFunctionPath(
                                            rsp.getParentServiceFunctionPath());
        ...
        if (serviceFunctionChain == null) {
            LOG.error("iOAM:PoT:ServiceFunctionChain name for Path {} is invalid.",
                      sfp.getName());
            return false;
        }
