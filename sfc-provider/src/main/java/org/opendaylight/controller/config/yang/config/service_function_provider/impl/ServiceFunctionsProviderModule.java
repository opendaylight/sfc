...
public class ServiceFunctionsProviderModule
	...
	public java.lang.AutoCloseable createInstance() {
		...
		opendaylightSFs.setDataProvider(getDataBrokerDependency(), null);

		// Register our OpendaylightToaster instance as the RPC implementation
		// for the ToasterService.
		final BindingAwareBroker.RpcRegistration<ServiceFunctionService> rpcRegistration = getRpcRegistryDependency()
				.addRpcImplementation(ServiceFunctionService.class, opendaylightSFs);
