...
public class OpendaylightSfc implements AutoCloseable {
    ...
    private static SfcFixedThreadPoolImpl sfcFixedThreadPoolImpl;
    ...
    private void initSfcFixedThreadPool() {
        sfcFixedThreadPoolImpl = new SfcFixedThreadPoolImpl(SfcProviderUtils.EXECUTOR_THREAD_POOL_SIZE,
                SfcProviderUtils.THREAD_FACTORY, SfcProviderUtils.SHUTDOWN_TIME);
    }
    ...
    public void close() throws ExecutionException, InterruptedException {
        ...
        if (dataProvider != null) {
            ...
            // When we close this service we need to close the sfcFixedThreadPool service
            try {
                sfcFixedThreadPoolImpl.close();
            } catch (Exception e) {
                LOG.error("Error terminating sfcFixedThreadPoolImpl", e);
            }
        }
    }
}
