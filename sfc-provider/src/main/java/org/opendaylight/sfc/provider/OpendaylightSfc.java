...
public class OpendaylightSfc implements AutoCloseable {
    ...
    public OpendaylightSfc() {
        if (opendaylightSfcObj == null) {
            ...
            // Init for backwards compatibility of ServiceFunctionTypes.
    ...
    private void initServiceFunctionTypes() {
        ...
        WriteTransaction rX = dataProvider.newWriteOnlyTransaction();
        rX.put(LogicalDatastoreType.CONFIGURATION, SFT_IID, sftTypesBuilder.build());
    }
