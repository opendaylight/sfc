...
/**
 * This the main SFC Provider class that is instantiated in
...
public class OpendaylightSfc extends AbstractBindingAwareProvider implements BindingAwareProvider, AutoCloseable {
