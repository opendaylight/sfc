...
public class OpendaylightSfc implements AutoCloseable {
    ...
    public static final InstanceIdentifier<ServiceFunctionState> SFS_ENTRY_IID = InstanceIdentifier
    ...
    public void close() throws ExecutionException, InterruptedException {
        ...
        if (dataProvider != null) {
            ...
            final InstanceIdentifier<ServiceFunctionsState> sfsIid = InstanceIdentifier.builder(
            ...
            SfcDataStoreAPI.deleteTransactionAPI(sfsIid, LogicalDatastoreType.OPERATIONAL);
