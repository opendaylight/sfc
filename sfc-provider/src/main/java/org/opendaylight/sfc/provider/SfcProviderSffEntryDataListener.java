...
public class SfcProviderSffEntryDataListener implements DataChangeListener, AutoCloseable {
    ...
    private void registerListeners(DataBroker db) {
        //ServiceFunctionForwarder Entry
        try {
            sffDataChangeListenerRegistration = db.registerDataChangeListener(LogicalDatastoreType.CONFIGURATION,
                    OpendaylightSfc.SFF_ENTRY_IID, SfcProviderSffEntryDataListener.this, DataBroker.DataChangeScope.SUBTREE );
    ...
    public void close() throws Exception {
        ...
        LOG.debug("SffDataChangeListenerRegistration Closed");
    }
}
