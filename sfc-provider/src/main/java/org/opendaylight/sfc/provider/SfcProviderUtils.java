...
public class SfcProviderUtils {
    ...
    public SfcProviderUtils() {
        if (instance == null) {
            SfcProviderUtils.instance = this;
        }
    }
    ...
    public void setBindingAwareBroker(BindingAwareBroker bindingAwareBroker) {
        SfcProviderUtils.bindingAwareBroker = bindingAwareBroker;
    }
    ...
    public void setSfcFixedThreadPoolWrapper(SfcFixedThreadPoolWrapper sfcFixedThreadPoolWrapper) {
        SfcProviderUtils.executor = sfcFixedThreadPoolWrapper.getExecutor();
    }

    public static SfcProviderUtils getSfcProviderUtils() {
        return SfcProviderUtils.instance;
    }
}
