...
*/
     ...
     * @return RenderedServicePath.
     */
    public static RenderedServicePath createRspAdvanced(Class<? extends SlTransportType> transportType, Class<? extends ServiceFunctionSchedulerTypeIdentity> serviceFunctionSchedulerType, boolean symmetric, List<Class<? extends ServiceFunctionTypeIdentity>> serviceFunctionTypeList) {
        int i;
