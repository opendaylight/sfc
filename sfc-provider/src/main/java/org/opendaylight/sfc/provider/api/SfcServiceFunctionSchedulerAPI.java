...
public abstract class SfcServiceFunctionSchedulerAPI {
    private java.lang.Class<? extends org.opendaylight.yang.gen.v1.urn.intel
            .params.xml.ns.yang.sfc.sfst
            .rev150312.ServiceFunctionSchedulerTypeIdentity> sfcServiceFunctionSchedulerType;

    public java.lang.Class<? extends org.opendaylight.yang.gen.v1.urn.intel
            .params.xml.ns.yang.sfc.sfst
            .rev150312.ServiceFunctionSchedulerTypeIdentity> getSfcServiceFunctionSchedulerType() {
        return this.sfcServiceFunctionSchedulerType;
    }

    public void setSfcServiceFunctionSchedulerType(
            java.lang.Class<? extends org.opendaylight.yang.gen.v1.urn.intel
                    .params.xml.ns.yang.sfc.sfst
                    .rev150312.ServiceFunctionSchedulerTypeIdentity> schedulerType) {
        this.sfcServiceFunctionSchedulerType = schedulerType;
    }

    public abstract List<SfName> scheduleServiceFunctions(ServiceFunctionChain chain, int serviceIndex,
