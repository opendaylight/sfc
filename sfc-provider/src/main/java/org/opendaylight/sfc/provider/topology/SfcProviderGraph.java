...
public class SfcProviderGraph {
    ...
    public static Map<SfcProviderTopologyNode, Set<SfcProviderTopologyNode>> sfcProviderTopologyEdges = new HashMap<SfcProviderTopologyNode, Set<SfcProviderTopologyNode>>();
    public static List<SfcProviderTopologyNode> sfcProviderTopologyNodeList = new ArrayList<SfcProviderTopologyNode>();
    ...
    public static boolean getServiceFunctionForwarders4Topology()
    {
    ...
    public static boolean getServiceFunctions4Topology()
    {
    ...
    public static boolean getEdges4Topology()
    {
        ServiceFunctionForwarders sffs = SfcProviderServiceForwarderAPI.readAllServiceFunctionForwardersExecutor();
        List<ServiceFunctionForwarder> serviceFunctionForwarderList = sffs.getServiceFunctionForwarder();
    ...
    public static void insertEdge(SfcProviderTopologyNode preSfcNode, SfcProviderTopologyNode curSfcNode)
    {
    ...
    public static void breadthFirstSearch(SfcProviderTopologyNode sfcProviderTopologyNode)
    {
