...
public class SfcDatastoreCache {
     ...
     */
    public static LoadingCache<SfName, String> sfToSfTypeCache = CacheBuilder.newBuilder()
            .maximumSize(500)
     ...
     */
    public static LoadingCache<SfcName, List<String>> sfChainToSfTypeList = CacheBuilder.newBuilder()
            .maximumSize(500)
