...
public class SfcProviderSfEntryDataListenerTest extends AbstractDataStoreManager {
    ...
    public void testOnDataChanged_RemoveDataWithRSP() throws Exception {
        ...
        RenderedServicePath renderedServicePath = build_rendered_service_path();
     ...
     * @return RSP object
     */
    RenderedServicePath build_rendered_service_path() throws Exception {
        String[] LOCATOR_IP_ADDRESS =
        ...
        Logger LOG = LoggerFactory.getLogger(SfcProviderServiceChainAPITest.class);
