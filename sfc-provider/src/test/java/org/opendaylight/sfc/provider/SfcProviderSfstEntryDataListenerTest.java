...
public class SfcProviderSfstEntryDataListenerTest extends AbstractDataStoreManager {
    ...
    private static final SfcProviderSfstEntryDataListener sfstEntryDataListener = new SfcProviderSfstEntryDataListener();
    ...
    public ListenerRegistration<DataChangeListener> registerAsDataChangeListener() {
        return dataBroker.registerDataChangeListener(LogicalDatastoreType.CONFIGURATION,
            OpendaylightSfc.SFST_ENTRY_IID, sfstEntryDataListener,DataBroker.DataChangeScope.SUBTREE);
    }
     ...
     * - creates SFST object and inserts it into an MAP data structure representing the original data
     * - creates a IID and add to removedPaths data structure. This IID points to the SFST objects stored in the
     *   original data
    ...
    public void testOnDataChanged_UpdateSFSTData() throws Exception {
        ...
        ServiceFunctionSchedulerTypeBuilder updatedServiceFunctionSchedulerTypeBuilder = new ServiceFunctionSchedulerTypeBuilder(serviceFunctionSchedulerType);
    ...
    ServiceFunctionSchedulerType build_service_function_scheduler_type() {
        ...
        sfstBuilder.setName(SFST_NAME).setKey(key)
    ...
    public void testNumOfEnabledAlgorithmType() throws Exception {
        ...
        InstanceIdentifier<ServiceFunctionSchedulerTypes> sfstsEntryIID = InstanceIdentifier.builder(ServiceFunctionSchedulerTypes.class).build();

        count = countNumOfEnabledAlgorithmType();
        assertEquals("Must be equal", count, numOfTrue);
    ...
    public void build_service_function_scheduler_types() throws Exception {
        ...
        Class[] schedulerTypes =
                {Random.class, RoundRobin.class, LoadBalance.class};
        Boolean enabledStatus = true;
