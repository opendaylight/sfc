...
public class SfcProviderServiceFunctionGroupAlgAPITest extends AbstractDataStoreManager {
    ...
    public void readServiceFunctionGroupAlgTest() {
        ...
        ServiceFunctionGroupAlgorithmKey serviceFunctionGroupAlgorithmKey = new ServiceFunctionGroupAlgorithmKey(
                "SFG1");
        InstanceIdentifier<ServiceFunctionGroupAlgorithm> sfgAlgIID = InstanceIdentifier
        ...
        SfcDataStoreAPI.writePutTransactionAPI(sfgAlgIID, serviceFunctionGroupAlgorithm,
                LogicalDatastoreType.CONFIGURATION);

        assertNotNull(SfcProviderServiceFunctionGroupAlgAPI.readServiceFunctionGroupAlg("SFG1"));

        ServiceFunctionGroupAlgorithm sfga = SfcDataStoreAPI.readTransactionAPI(sfgAlgIID,
                LogicalDatastoreType.CONFIGURATION);
