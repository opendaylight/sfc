...
public class SfcProviderServicePathAPITest extends AbstractDataBrokerTest {
    ...
    public void testIsDefaultServicePath(){
        ...
        ServicePathHop servicePathHopMock = mock(ServicePathHop.class);
        List<ServicePathHop> servicePathHopList = new ArrayList<>();
        servicePathHopList.add(servicePathHopMock);
        serviceFunctionPathBuilder.setName("SFP1").setKey(new ServiceFunctionPathKey("SFP1")).setStartingIndex((short)5).setPathId((long)236)
                .setTransportType(transportType).setServicePathHop(servicePathHopList);
        ServiceFunctionPath serviceFunctionPath = serviceFunctionPathBuilder.build();
        assertFalse(SfcProviderServicePathAPI.isDefaultServicePath(serviceFunctionPath));
    }
    ...
    public void testPutAllServiceFunctionPaths(){
        ...
        SfcProviderServicePathAPILocal sfcProviderServicePathAPILocal = new SfcProviderServicePathAPILocal(params, paramsTypes, "m");
...
//    }
    ...
    private class SfcProviderServicePathAPILocal extends SfcProviderServicePathAPI{
        ...
        SfcProviderServicePathAPILocal(Object[] params, Class[] paramsTypes, String m) {
