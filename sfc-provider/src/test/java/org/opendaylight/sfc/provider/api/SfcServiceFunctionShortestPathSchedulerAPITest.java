...
public class SfcServiceFunctionShortestPathSchedulerAPITest extends AbstractDataBrokerTest {
    ...
    public void testSfcServiceFunctionShortestPathScheduler() throws ExecutionException, InterruptedException {
        ...
        Object[] parametersRSP = {serviceFunctionNameArrayList.get(0)};
        Class[] parameterTypesRSP = {String.class};
        Object resultRSP = executor.submit(SfcProviderServiceFunctionAPI
                                .getRead(parametersRSP, parameterTypesRSP)).get();
        ServiceFunction sfRSP0 = (ServiceFunction) resultRSP;
        String sffRSP0 = sfRSP0.getSfDataPlaneLocator().get(0).getName();

        Object[] parametersRSP1 = {serviceFunctionNameArrayList.get(1)};
        Class[] parameterTypesRSP1 = {String.class};
        Object resultRSP1 = executor.submit(SfcProviderServiceFunctionAPI
                                .getRead(parametersRSP1, parameterTypesRSP1)).get();
        ServiceFunction sfRSP1 = (ServiceFunction) resultRSP1;
        String sffRSP1 = sfRSP1.getSfDataPlaneLocator().get(0).getName();

        Object[] parametersRSP2 = {serviceFunctionNameArrayList.get(2)};
        Class[] parameterTypesRSP2 = {String.class};
        Object resultRSP2 = executor.submit(SfcProviderServiceFunctionAPI
                                .getRead(parametersRSP2, parameterTypesRSP2)).get();
        ServiceFunction sfRSP2 = (ServiceFunction) resultRSP2;
        String sffRSP2 = sfRSP2.getSfDataPlaneLocator().get(0).getName();

        assertEquals("Must be equal", sffRSP0, sffRSP1);
        assertEquals("Must be equal", sffRSP1, sffRSP2);
    }
}
