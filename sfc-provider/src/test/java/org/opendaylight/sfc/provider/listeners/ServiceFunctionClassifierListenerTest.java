...
public class ServiceFunctionClassifierListenerTest extends AbstractDataStoreManager {
    ...
    public void testOnServiceFunctionClassifierCreated() throws Exception {
        ServiceFunctionClassifier serviceFunctionClassifier = build_service_function_classifier();
    ...
    public void testOnServiceFunctionClassifierUpdated() throws Exception {
        ...
        ServiceFunctionClassifier originalServiceFunctionClassifier = build_service_function_classifier();
     ...
     */
    ServiceFunctionClassifier build_service_function_classifier() {
