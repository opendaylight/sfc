...
from sfc.nsh.common import NSH_NEXT_PROTO_ETH, NSH_NEXT_PROTO_IPV4, OAM_TRACE_REQ_TYPE, 
from sfc.nsh.common import process_context_headers, TRACEREQHEADER, VXLAN, VXLANGPE
...
from sfc.nsh.encode import build_trace_req_header, build_udp_packet
