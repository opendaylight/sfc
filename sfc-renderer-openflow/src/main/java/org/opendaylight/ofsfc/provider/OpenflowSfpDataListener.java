...
public class OpenflowSfpDataListener implements DataChangeListener {
    ...
    private void installDefaultNextHopEntry(long sfpId, ServicePathHop servicePathHop) {
        ...
        ServiceFunction sf = SfcProviderServiceFunctionAPI.readServiceFunction(servicePathHop.getServiceFunctionName());
    ...
    private void writeSffFlows(ServiceFunctionPaths updatedServiceFunctionPaths) {
        ...
        while (sfpIter.hasNext()) {
            ...
            OpenflowSfcFlowProgrammer flowProgrammer;
            
            flowProgrammer = OpenflowSfcFlowProgrammer.getInstance();
            ...
            while (sfpSpHop.hasNext()) {
                ...
                ServiceFunctionForwarder curSff = SfcProviderServiceForwarderAPI.readServiceFunctionForwarder(
                        odlSfc.getDataProvider(), curSFFName);
                ...
                for (SffDataPlaneLocator curSffDataPlanelocator : curSffDataPlanelocatorList) {
                    ...
                    if (curSFFLocatorType.getImplementedInterface().equals(Mac.class)) {
                        int curSFFVlan = ((MacAddressLocator) curSffDataPlanelocator.getDataPlaneLocator().getLocatorType())
                                .getVlanId();
                ...
                ServiceFunction curSF = SfcProviderServiceFunctionAPI.readServiceFunction(servicePathHopCur
                ...
                if (servicePathHopPrev == null) {
                    ...
                    prevSFF = SfcProviderServiceForwarderAPI.readServiceFunctionForwarder(
                            odlSfc.getDataProvider(), servicePathHopPrev.getServiceFunctionForwarder());
                    prevSF = SfcProviderServiceFunctionAPI.readServiceFunction(servicePathHopPrev
                            .getServiceFunctionName());
                    ...
                    for (SfDataPlaneLocator prevSFDataPlanelocator : prevSFDataPlaneLocatorList) {
                    	...
                    	if (curSFLocatorType.getImplementedInterface().equals(Mac.class)) {
	                        prevSFSrcMac = ((MacAddressLocator) prevSFDataPlanelocator.getLocatorType()).getMac().toString();
                    ...
                    if (prevSFF.equals(curSff)) {
                        for (SfDataPlaneLocator curSfDataPlanelocator : curSfDataPlaneLocatorList) {
	                    	...
	                    	if (curSFLocatorType.getImplementedInterface().equals(Mac.class)) {
		                        ...
		                        flowProgrammer.writeNextHopFlow(sfp.getPathId(), prevSFSrcMac, dstMac,
		                                dstVlan);
                        ...
                        for (SffDataPlaneLocator prevSFFDataPlanelocator : prevSFFDataPlanelocatorList) {
                        	...
                        	if (curSFFLocatorType.getImplementedInterface().equals(Mac.class)) {
	                            ...
	                            flowProgrammer
	                                    .setNodeInfo(servicePathHopPrev.getServiceFunctionForwarder());
	                            flowProgrammer.writeNextHopFlow(sfp.getPathId(), prevSFSrcMac, dstMacSff,
	                                    dstVlanSff);
		                        // TODO add support for multiple data plane locators
		                        break;
                        	}
