...
public interface SfcOfFlowProgrammerInterface {
     ...
     * @param openflowName  The openflow identifier for the node on which the flows are to be written
     ...
     * @param flowPriority   Flow priority to use
     * @param cookieStr      Flow cookie to use
     */
