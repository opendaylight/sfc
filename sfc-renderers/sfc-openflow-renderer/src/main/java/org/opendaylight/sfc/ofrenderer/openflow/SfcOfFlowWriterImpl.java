...
public class SfcOfFlowWriterImpl implements SfcOfFlowWriterInterface {
    ...
    // Having the list of flows indexed by the SFF they belong to
    // helps us to keep track of the installed rules - see BUG#5969
    ...
    public Set<NodeId> clearSffsIfNoRspExists() {
        ...
        Map<String, List<FlowDetails>> theInitializationFlows =
                rspNameToFlowsMap.get(SfcOfFlowProgrammerImpl.SFC_FLOWS);
