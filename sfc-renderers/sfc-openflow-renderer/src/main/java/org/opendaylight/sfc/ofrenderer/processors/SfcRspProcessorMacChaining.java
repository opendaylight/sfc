    ...
    public void setRspTransports() {
        ...
        while (sffGraphIter.hasNext()) {
            ...
            if (!entry.getDstSff().equals(entry.getSrcSff())
                ...
                SffDataPlaneLocator srcSffDplEgress = SfcModelUtil.serachSrcDplInConnectedSffs(
                ...
                SffDataPlaneLocator dstSffDplIngress = SfcModelUtil.serachSrcDplInConnectedSffs(
    ...
    public void configureNextHopFlow(SffGraph.SffGraphEntry entry, SffDataPlaneLocator srcSffDpl,
        ...
        if (entry.getPrevSf() != null) {
            ...
            ServiceFunctionType serviceFunctionType =
                    SfcProviderServiceTypeAPI.readServiceFunctionType(prevSf.getType());
