...
public class SfcRspProcessorNshVxgpe extends SfcRspTransportProcessorBase {
    ...
    public void configureSfTransportIngressFlow(SffGraph.SffGraphEntry entry, SfDataPlaneLocator sfDpl) {
        // If its Eth+NSH call into SfcRspProcessorNshEth.configureSfTransportIngressFlow()
        if(sfDpl.getLocatorType() instanceof Mac) {
            // In this case, the SfLoopbackEncapsulatedEgress and SfReturnLoopbackIngress flows are not needed
            getSfcRspProcessorNshEth();
    ...
    public void configureSfTransportEgressFlow(
        ...
        // If its Eth+NSH call into SfcRspProcessorNshEth.configureSfTransportEgressFlow()
        if(dstSfDpl.getLocatorType() instanceof Mac) {
            getSfcRspProcessorNshEth();
