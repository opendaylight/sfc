...
public abstract class SfcOfBaseProviderUtils {
     ...
     */
    private SfDataPlaneLocator getSfDataPlaneLocator(ServiceFunction sf, final SffName sffName) {
        List<SfDataPlaneLocator> sfDataPlanelocatorList = sf.getSfDataPlaneLocator();
    ...
    /**
     * Returns the {@link SfDataPlaneLocator} to be used for the ingress from
     * the SF towards the SFF in relation with a direction of a path.
     *
     * @param sf
     *            - The SF
     * @param sff
     ...
     * @return SfDataPlaneLocator or null if not found
     */
    public SfDataPlaneLocator getIngressSfDataPlaneLocator(ServiceFunction sf,
    ...
    /**
     * Returns the {@link SfDataPlaneLocator} to be used for the egress from
     * the SFF towards the SF in relation with a direction of a path.
     *
     * @param sf
     *            - The SF
     * @param sff
     ...
     * @return SfDataPlaneLocator or null if not found
     */
    public SfDataPlaneLocator getEgressSfDataPlaneLocator(ServiceFunction sf,
                                                          ServiceFunctionForwarder sff,
                                                          boolean isForwardPath) {
        SffSfDataPlaneLocator sffSfDpl = getSffSfDataPlaneLocator(sff, sf);
    ...
    /**
     * Returns the {@link SffDataPlaneLocator} to be used for the egress from
     * the SFF towards the SF in relation with a direction of a path.
     *
     * @param sf
     *            - The SF
     ...
     * @return SffDataPlaneLocator or null if not found
     */
    public SffDataPlaneLocator getEgressSffDataPlaneLocator(ServiceFunction sf,
                                                            ServiceFunctionForwarder sff,
                                                            boolean isForwardPath) {
        SffSfDataPlaneLocator sffSfDpl = getSffSfDataPlaneLocator(sff, sf);
     ...
     *            - The SFF to search in
     * @param sfName
     *            - The name of the SFF to look for
