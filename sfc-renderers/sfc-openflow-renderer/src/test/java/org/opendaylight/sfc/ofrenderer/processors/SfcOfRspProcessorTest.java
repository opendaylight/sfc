...
public class SfcOfRspProcessorTest {
    ...
    public SfcOfRspProcessorTest() {
        ...
        this.sfcOfRspProcessor = new SfcOfRspProcessor(this.flowProgrammerTestMoc, this.sfcUtilsTestMock,
                new SfcSynchronizer(), new SfcStatisticsManagerImpl(), null, null);
    ...
    public void testVxgpeNshSffEthNshSfFlowCreation() {
        ...
        RenderedServicePath ethNshRsp =
            rspBuilder.createRspFromSfList(sfList, new SffName(sffName), VxlanGpe.class, Nsh.class);
