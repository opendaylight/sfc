 ...
 * @version 0.1
 * @see org.opendaylight.sfc.pot.netconf.renderer.provider.api.SfcPotPolyClass
 * @since 2016-05-01
 */
public class SfcPotPolyClass {
    ...
    SfcPotPolyClass(long prime, long secret, List<Coeffs> coeffs, List<Long> shares,
            List<Lpcs> lpcs, long sfcsize) {
        this.prime = prime;
        this.secret = secret;
        this.coeffs = coeffs;
        this.shares = shares;
