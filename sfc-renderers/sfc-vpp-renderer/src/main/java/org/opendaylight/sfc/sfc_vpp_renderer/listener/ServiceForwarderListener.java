            ...
            switch (rootNode.getModificationType()) {
                ...
                case SUBTREE_MODIFIED:
                    if (rootNode.getDataAfter() != null
                        ...
                        sffManager.disposeSff(rootNode.getDataAfter().getServiceFunctionForwarder(), false);
                    }
                    break;
                case DELETE:
                    if (rootNode.getDataBefore() != null
                            && rootNode.getDataBefore().getServiceFunctionForwarder() != null) {
                        sffManager.disposeSff(rootNode.getDataBefore().getServiceFunctionForwarder(), true);
                    }
                    break;
            }
        }
