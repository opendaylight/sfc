    ...
    private ObjectNode getDescriptionMonitorObjectNode(SfcSfDescMon sfcSfDescMon) {
        ...
        if (sfcSfDescMon.getMonitoringInfo() != null) {
            ...
            if (sfMonitoringInfo.getResourceUtilization() != null) {
                ...
                resourceUtilizationNode.put(PACKET_RATE_UTILIZATION, resourceUtilization.getPacketRateUtilization().toJava());
                resourceUtilizationNode.put(BANDWIDTH_UTILIZATION, resourceUtilization.getBandwidthUtilization().toJava());
                ...
                if (resourceUtilization.getSFPortsBandwidthUtilization() != null) {
                    ...
                    for (PortBandwidthUtilization portBandwidthUtilization : portsBandwidthUtilization
                        ...
                        portBandwidthUtilizationNode.put(RX_BYTES_RATE, portBandwidthUtilization.getRxBytesRate().toJava());
                        portBandwidthUtilizationNode.put(TX_BYTES_RATE, portBandwidthUtilization.getTxBytesRate().toJava());
                        portBandwidthUtilizationNode.put(RX_PACKET_RATE, portBandwidthUtilization.getRxPacketRate().toJava());
                        portBandwidthUtilizationNode.put(TX_PACKET_RATE, portBandwidthUtilization.getTxPacketRate().toJava());
