...
public class SfstateExporterTest {
    ...
    private String gatherServiceFunctionStateJsonStringFromFile(String testFileName) {
        ...
        for (SfstateTestValues sfstateTestValue : SfstateTestValues.values()) {
            jsonString = jsonString != null ? jsonString.replaceAll("\\b" + sfstateTestValue.name() + "\\b", sfstateTestValue.getValue()) : null;
        }
    ...
    private boolean testExportSfstateJson(String expectedResultFile, boolean nameOnly) throws IOException {
        ...
        JsonNode expectedSfstateJson = objectMapper.readTree(this.gatherServiceFunctionStateJsonStringFromFile(expectedResultFile));
    ...
    private ServiceFunctionState buildServiceFunctionState() {
        ...
        ServiceStatistics serviceStatistics = new ServiceStatisticsBuilder()
            .setBytesIn(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.BYTES_IN.getValue()))))
            .setBytesOut(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.BYTES_OUT.getValue()))))
            .setPacketOut(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.PACKETS_OUT.getValue()))))
            .setPacketsIn(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.PACKETS_IN.getValue())))).build();
        ...
        ServiceStatistics pathserviceStatistics = new ServiceStatisticsBuilder()
            .setBytesIn(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.PATH_BYTES_IN.getValue()))))
            .setBytesOut(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.PATH_BYTES_OUT.getValue()))))
            .setPacketOut(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.PATH_PACKETS_OUT.getValue()))))
            .setPacketsIn(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.PACKETS_IN.getValue())))).build();
        ...
        ServiceFunctionStateKey serviceFunctionStateKey = new ServiceFunctionStateKey(SfstateTestValues.NAME.getValue());
    ...
    private DescriptionInfo buildSfDescriptionInfo() {
        ...
        PortBandwidth portBandwidth1= new PortBandwidthBuilder()
            .setIpaddress(new Ipv4Address(SfstateTestValues.IPADDRESS1.getValue()))
        ...
        PortBandwidth portBandwidth2= new PortBandwidthBuilder()
            .setIpaddress(new Ipv4Address(SfstateTestValues.IPADDRESS2.getValue()))
    ...
    private MonitoringInfo buildSfMonitoringInfo() {
        ...
        PortBandwidthUtilizationKey portBandwidthUtilKey1 = new PortBandwidthUtilizationKey(Long.valueOf(SfstateTestValues.PORT_ID1.getValue()));
        PortBandwidthUtilizationKey portBandwidthUtilKey2 = new PortBandwidthUtilizationKey(Long.valueOf(SfstateTestValues.PORT_ID2.getValue()));
        ...
        PortBandwidthUtilization portBandwidthUtil1 = new PortBandwidthUtilizationBuilder()
            ...
            .setRxBytes(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.RX_BYTES1.getValue()))))
            .setRxPacket(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.RX_PACKET1.getValue()))))
            ...
            .setTxBytes(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.TX_BYTES1.getValue()))))
            .setTxPacket(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.TX_PACKET1.getValue()))))
        ...
        PortBandwidthUtilization portBandwidthUtil2 = new PortBandwidthUtilizationBuilder()
            ...
            .setRxBytes(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.RX_BYTES2.getValue()))))
            .setRxPacket(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.RX_PACKET2.getValue()))))
            ...
            .setTxBytes(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.TX_BYTES2.getValue()))))
            .setTxPacket(new ZeroBasedCounter64(new Counter64(new BigInteger(SfstateTestValues.TX_PACKET2.getValue()))))
