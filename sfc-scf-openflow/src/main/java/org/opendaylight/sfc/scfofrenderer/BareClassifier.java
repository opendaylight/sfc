...
public class BareClassifier implements ClassifierInterface {
    ...
    public BareClassifier() { sff=null; }
    ...
    @Override
    public FlowBuilder createClassifierInFlow(String flowKey, SfcNshHeader sfcNshHeader, Long port) {
        return SfcScfOfUtils.createClassifierInFlow(flowKey, sfcNshHeader, port);
    }

    @Override
    public FlowBuilder createClassifierRelayFlow(String flowKey, SfcNshHeader sfcNshHeader) {
        return SfcScfOfUtils.createClassifierRelayFlow(flowKey, sfcNshHeader);
    }
