...
public class ClassifierGeniusIntegration {
     ...
     */
    protected static void performGeniusServiceBinding(WriteTransaction theTx, String ifName) {
     ...
     * @param ifName    the name of the logical interface
     */
    protected static void performGeniusServiceUnbinding(WriteTransaction theTx, String ifName) {
        GeniusServiceBinder geniusBinder = new GeniusServiceBinder();
