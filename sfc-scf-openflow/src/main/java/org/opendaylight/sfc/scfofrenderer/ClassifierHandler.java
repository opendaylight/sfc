...
public interface ClassifierHandler {
     ...
     */
    default String buildFlowKeyName(String scfName, String aclName, String aceName, String type) {
     ...
     */
    default RspName getReverseRspName(RspName rspName) {
     ...
     */
    default  Optional<String> getInterfaceNameFromClassifier(SclServiceFunctionForwarder theClassifier) {
     ...
     */
    default  FlowDetails deleteFlowFromTable(String nodeName, String flowKey, short tableID) {
     ...
     * @return          the {@link FlowDetails} object that identifies the desired flow
     */
    default  FlowDetails addRspRelatedFlowIntoNode(String nodeName, FlowBuilder flow, long rspId) {
     ...
     */
    default boolean usesLogicalInterfaces(ServiceFunctionForwarder theSff) {
