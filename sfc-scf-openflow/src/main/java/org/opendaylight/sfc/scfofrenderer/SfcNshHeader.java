...
public class SfcNshHeader {
    ...
    public static SfcNshHeader getSfcNshHeader(String rspName) {
        RenderedServicePath renderedServicePath = SfcProviderRenderedPathAPI.readRenderedServicePathExecutor(rspName);
        ...
        //String context = "NSH1";
        ContextMetadata md = SfcProviderServiceFunctionMetadataAPI.readContextMetadataExecutor(context);
