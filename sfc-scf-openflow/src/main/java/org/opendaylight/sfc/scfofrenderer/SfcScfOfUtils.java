...
public class SfcScfOfUtils {
    ...
    public static boolean createClassifierOutFlow(String nodeName, String flow, Match match, SfcNshHeader sfcNshHeader,
            Long outPort) {
        int order = 0;

        if ((nodeName == null) || (flow == null) || (sfcNshHeader == null) || (sfcNshHeader.getVxlanIpDst()==null)) {
            return false;
        }
    ...
    public static boolean createClassifierInFlow(String nodeName, String flow, SfcNshHeader sfcNshHeader, Long outPort) {
        int order = 0;
    ...
    public static boolean createClassifierRelayFlow(String nodeName, String flow, SfcNshHeader sfcNshHeader) {
        int order = 0;
