...
public class LogicallyAttachedClassifier implements ClassifierInterface {
    ...
    public LogicallyAttachedClassifier(LogicallyAttachedClassifier original) {
        this.logicalSffDataGetter = original.logicalSffDataGetter;
    }
    ...
    public FlowBuilder createClassifierOutFlow(String flowKey,
        ...
        Optional<DpnIdType> firstHopDataplaneId = logicalSffDataGetter.getFirstHopDataplaneId(sfcNshHeader.getRsp());
        if(firstHopDataplaneId.isPresent() && classifierNodeDpnId.equals(firstHopDataplaneId.get())) {
        ...
        {
            DpnIdType firstHopDpnId = firstHopDataplaneId.get();
            String theTunnelIf = logicalSffDataGetter.getInterfaceBetweenDpnIds(classifierNodeDpnId, firstHopDpnId)
                    .orElseThrow(RuntimeException::new);

            LOG.info("createClassifierOutFlow - Must go through tunnel: {}. src: {}; dst: {}",
                    theTunnelIf,
                    classifierNodeDpnId.getValue().toString(),
                    firstHopDpnId.getValue().toString());
