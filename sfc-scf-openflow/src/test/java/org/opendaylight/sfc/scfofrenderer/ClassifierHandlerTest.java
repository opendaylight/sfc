...
public class ClassifierHandlerTest {
    ...
    @Test
    public void getReverseRspNameSampleRsp() {
        Assert.assertEquals(new RspName("rsp1-Reverse"), handler.getReverseRspName(new RspName("rsp1")));
    }

    @Test
    public void getReverseRspNameReverseRsp() {
        Assert.assertEquals(new RspName("rsp1"), handler.getReverseRspName(new RspName("rsp1-Reverse")));
    }
