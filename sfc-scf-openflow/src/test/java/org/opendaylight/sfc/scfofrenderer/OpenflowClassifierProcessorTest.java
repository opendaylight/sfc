...
public class OpenflowClassifierProcessorTest {
    ...
    LogicallyAttachedClassifier logicalClassifier;
    ...
    public void setUp() {
        ...
        logicalClassifier = Mockito.spy(new LogicallyAttachedClassifier(sff, dataGetter));
        doReturn(Optional.of(FIRST_SF_NODE_NAME)).when(logicalClassifier).getNodeName(anyString());
        doReturn(true).when(logicalClassifier).usesLogicalInterfaces();
    ...
    public void addClassifierLegacyScenario() {
        ...
        when(logicalClassifier.usesLogicalInterfaces()).thenReturn(false);
        ...
        new OpenflowClassifierProcessor(readWriteTransaction, rpcProvider, logicalClassifier);
