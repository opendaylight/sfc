...
public class SfcMatchTest {

    @Test
    public void setPortMatch() {
        Match match;
        match = new SfcMatch()
                    .setPortMatch(null)
                    .build();
    ...
    public void setEthMatch() {
        ...
        Assert.assertEquals(match.getEthernetMatch().getEthernetDestination().getAddress(), new MacAddress("00:00:00:00:00:01"));
        ...
        Assert.assertEquals(match.getEthernetMatch().getEthernetSource().getAddress(), new MacAddress("00:00:00:00:00:01"));
    ...
    public void setIpMatch() {
        ...
        Assert.assertEquals(((Ipv4Match)match.getLayer3Match()).getIpv4Destination(), new Ipv4Prefix("1.1.1.1/24"));
        ...
        match = new SfcMatch()
                    .setAclMatch(matches)
                    .build();
        Assert.assertEquals(((Ipv4Match)match.getLayer3Match()).getIpv4Source(), new Ipv4Prefix("1.1.1.1/24"));
        ...
        match = new SfcMatch()
                    ...
                    .build();
        Assert.assertEquals(((Ipv4Match)match.getLayer3Match()).getIpv4Source(), new Ipv4Prefix("1.1.1.1/24"));
        Assert.assertEquals(((Ipv4Match)match.getLayer3Match()).getIpv4Destination(), new Ipv4Prefix("2.2.2.2/24"));
    }

    @Test
    public void setIpv6Match() {
        Match match;
        match = new SfcMatch()
                     .setAclMatch(null)
                     .build();
        ...
        Assert.assertEquals(((Ipv6Match)match.getLayer3Match()).getIpv6Destination(), new Ipv6Prefix("0000:0000:0000:0000:0000:0000:0000:0001/128"));
        ...
        match = new SfcMatch()
                    .setAclMatch(matches)
                    .build();
        Assert.assertEquals(((Ipv6Match)match.getLayer3Match()).getIpv6Source(), new Ipv6Prefix("0000:0000:0000:0000:0000:0000:0000:0001/128"));
        ...
        match = new SfcMatch()
                    ...
                    .build();
        Assert.assertEquals(((Ipv6Match)match.getLayer3Match()).getIpv6Source(), new Ipv6Prefix("0000:0000:0000:0000:0000:0000:0000:0001/128"));
        Assert.assertEquals(((Ipv6Match)match.getLayer3Match()).getIpv6Destination(), new Ipv6Prefix("0000:0000:0000:0000:0000:0000:0000:0002/128"));
    }
}
