...
public class RspStatisticsHandler extends SfcStatisticsHandlerBase {
    ...
    public RspStatisticsHandler(int maxNumPeriods, RenderedServicePath rsp, SfcOfTableOffsets sfcOfTableOffsets) {
        super(maxNumPeriods);
        this.rsp = rsp;
    ...
    public void writeStatistics() {
        ...
        LOG.info("RspStatisticsHandler::writeStatistics firing");
        ...
        if (!status) {
            LOG.info("RspStatisticsHandler::writeStatistics not able to collect statistics");
            return;
        }
        ...
        LOG.info("RspStatisticsHandler::writeStatistics completed with statistics");
    }
    ...
    private boolean getVppStatistics(ServiceFunctionForwarder firstHopSff, ServiceFunctionForwarder lastHopSff,
        ...
        // Noop
        LOG.info("RspStatisticsHandler getVppStatistics is not implemented yet");
