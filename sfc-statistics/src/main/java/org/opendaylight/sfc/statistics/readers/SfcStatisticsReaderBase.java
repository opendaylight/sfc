...
public abstract class SfcStatisticsReaderBase {
    protected final ServiceFunctionForwarder sff;

    public SfcStatisticsReaderBase(ServiceFunctionForwarder sff) {
        this.sff = sff;
    }

    // This constructor can not be instantiated
    private SfcStatisticsReaderBase() {
        this.sff = null;
    }
