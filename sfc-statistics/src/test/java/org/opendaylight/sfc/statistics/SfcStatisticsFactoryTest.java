...
public class SfcStatisticsFactoryTest extends AbstractDataStoreManager {
    ...
    public void getRspHandlerOpenFlowTest() {
        List<ServiceFunctionForwarder> sffList = sfcStatsTestUtils.createOpenflowSffs(1, Collections.emptyList());
    ...
    public void getRspHandlerOpenFlowLogicalTest() {
        RenderedServicePath rsp = sfcStatsTestUtils.createLogicalRsp();
