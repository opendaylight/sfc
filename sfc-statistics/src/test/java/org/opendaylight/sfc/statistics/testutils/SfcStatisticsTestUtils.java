...
public class SfcStatisticsTestUtils {
    ...
    public List<ServiceFunctionPath> createSfps(int numSfps, List<ServiceFunctionChain> sfcList,
                                                   boolean isSymmetric) {
    ...
    public List<ServiceFunctionForwarderBuilder> createBaseSffsBuilder(int numSffs, List<ServiceFunction> sfList) {
