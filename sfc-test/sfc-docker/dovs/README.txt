    ...
    - the utility /usr/local/sbin/pipework, to wire instance network interfaces
      to dovsbr0 and assign IPs through dhcp. dovsbr0 bridges the management
      network that OVS will use to connect to the controller. docker0 bridges
    ...
    Subcommand sfc-config allows:
     ...
     - Setting Service Function Chains (SFC) Configuration in Opendaylight Controller (ODL)
