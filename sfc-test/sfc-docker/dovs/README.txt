    ...
    Example 2: Networking of 2 compute nodes, 4 VMs and 2 isolated subnets.
     ...
     Example 4: Create a symmetric chain (one uplink and one downlink) with one SF

     Using the following command, three nodes with one guest per node (client,
     ...
     Create the classification rule using Netvirt classifier
