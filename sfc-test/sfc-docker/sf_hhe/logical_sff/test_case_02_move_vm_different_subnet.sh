...
# - Launch traffic
./exec_logical_sfc.py --odl ${odl_url} -d ../sf_hhe --chains "[['client3', 'dpi, qos, ids', 'server3']]" -rsnt
status=$?
...
# - Launch traffic
./exec_logical_sfc.py --odl ${odl_url} -d ../sf_hhe --chains "[['client3', 'dpi, qos, ids', 'server3']]" -t
status=$?

# Remove sfc configuration and topology
./exec_logical_sfc.py --odl ${odl_url} -d ../sf_hhe --chains "[['client3', 'dpi, qos, ids', 'server3']]" --remove-sfc
