...
if __name__ == "__main__":
    ...
    post_rpc(SFF_OVS_RPC_URL, SERVICE_FORWARDER_OVS_RPC_REQ_1, SERVICE_FORWARDER_OVS_RPC_RESP)
    post_rpc(SFF_OVS_RPC_URL, SERVICE_FORWARDER_OVS_RPC_REQ_2, SERVICE_FORWARDER_OVS_RPC_RESP)
