    ...
    "service-function": [
      {
        ...
        "sf-data-plane-locator": [
          {
            "name": "dp2",
            "service-function-forwarder": "ovsdb://127.0.0.1:55505/bridge/br2",
      ...
      },
      {
        ...
        "sf-data-plane-locator": [
          {
            "name": "dp1",
            "service-function-forwarder": "ovsdb://127.0.0.1:55505/bridge/br1",
            "transport": "service-locator:vxlan-gpe"
          }
        ]
      }
...
SERVICE_FUNCTION_FORWARDERS_OPER_JSON = """
{
  "service-function-forwarders-state": {
    "service-function-forwarder-state": [
      {
        "name": "ovsdb://127.0.0.1:55505/bridge/br1",
        "sff-service-path": [
          {
            "name": "ovs-sfp-Path-1"
          }
      ...
      {
        "name": "ovsdb://127.0.0.1:55505/bridge/br2",
        "sff-service-path": [
          {
            "name": "ovs-sfp-Path-1"
          }
