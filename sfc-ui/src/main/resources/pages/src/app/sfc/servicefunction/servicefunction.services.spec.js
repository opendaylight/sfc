  ...
  ddescribe('SFC app', function () {
    ...
    describe('servicefunction.services', function () {
      ...
      describe('ServiceFunctionHelper', function () {
        ...
        it("should convert nsh-aware boolean value to string", function () {
          ServiceFunctionHelper.nshAwareToString(exampleData.sf);
          expect(exampleData.sf['nsh-aware']).toEqual('true');
          exampleData.sf['nsh-aware'] = false;
          ServiceFunctionHelper.nshAwareToString(exampleData.sf);
          expect(exampleData.sf['nsh-aware']).toEqual('false');
          //should do nothing, but cannot cause error
          ServiceFunctionHelper.nshAwareToString({});
        });
