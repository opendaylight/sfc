define(['app/sfc/sfc.test.module.loader'], function (sfc) {
  ...
  ddescribe('SFC app', function () {
    ...
    serviceFunctionStateSvcMock = {
      getOperationalArray: function (callback) {
    ...
    describe('servicenode.controller', function () {
      ...
      describe('serviceNodeCtrl', function () {
        ...
        it("should call get Service Function States", function () {
          spyOn(serviceFunctionStateSvcMock, 'getOperationalArray').andCallThrough();
          createServiceNodeCtrl();
          expect(serviceFunctionStateSvcMock.getOperationalArray).toHaveBeenCalledWith(jasmine.any(Function));
