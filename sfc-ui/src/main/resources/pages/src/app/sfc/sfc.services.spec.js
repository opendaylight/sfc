    ...
    describe("sfc.services", function () {
      ...
      describe("Test ServiceFunctionStateSvc", function () {
        ...
        it("getArray - should return nested array from container with namespace stripped for type", angular.mock.inject(function () {
          ...
          httpBackend.expectGET('http://localhost:8080/restconf/operational/service-function-state:service-function-states').respond(mockToRespond);

          ServiceFunctionStateSvc.getOperationalArray(function (sfstateArrayData) {
            expect(sfstateArrayData).toEqual(mockToRespond["service-function-states"]["service-function-state"]);
          });
