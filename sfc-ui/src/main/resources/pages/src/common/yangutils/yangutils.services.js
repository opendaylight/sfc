define(['common/yangutils/yangutils.module'], function (yangUtils) {
    ...
    yangUtils.factory('YangUtilsRestangular', function (Restangular, SfcRestangularSvc) {
        return Restangular.withConfig(function (RestangularConfig) {
            RestangularConfig.setBaseUrl(SfcRestangularSvc.getCurrentBaseUrl());
        });
    });
    ...
    yangUtils.factory('yinParser', function ($http, syncFact, constants, arrayUtils, pathUtils) {
        ...
        var Module = function (name, revision, namespace) {
            ...
            this.addChild = function (node) {
                ...
                if (duplicates && duplicates.length > 0) {
                    ...
                    if (node.nodeType === constants.NODE_UI_DISPLAY || node.nodeType === constants.NODE_IDENTITY) {
        ...
        var YangParser = function () {
            ...
            this.identity = function (xml, parent) {
                var type = 'identity',
                    name = $(xml).attr('name'),
                    nodeType = constants.NODE_IDENTITY,
                    node = this.createNewNode(name, type, parent, nodeType);
            ...
            this.base = function (xml, parent) {
                var type = 'base',
                  name = $(xml).attr('name'),
                  nodeType = constants.NODE_IDENTITY_BASE;
