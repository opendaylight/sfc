define(['common/yangutils/yangutils.module'], function (yangUtils) {
    ...
    yangUtils.factory('YangUtilsRestangular', function (Restangular) {
        ...
        var Module = function (name, revision, namespace) {
            ...
            this.addChild = function (node) {
                ...
                if (duplicates && duplicates.length > 0) {
                    ...
                    if (node.nodeType === constants.NODE_UI_DISPLAY || node.nodeType === constants.NODE_IDENTITY || node.nodeType === constants.NODE_LINK_TARGET) {
