define(['app/sfc/sfc.module'], function (sfc) {
  ...
  sfc.register.controller('serviceChainCtrl', function ($scope, $rootScope, ServiceFunctionSvc, ServiceChainSvc, ServicePathSvc,
                                                        ModalDeleteSvc, ModalSfNameSvc, ModalSfpInstantiateSvc, ModalInfoSvc,
                                                        ModalErrorSvc, ngTableParams, $filter, $timeout) {
    var NgTableParams = ngTableParams;

    $timeout(function() {
      $rootScope.$watch('sfcs', function (newVal, oldVal) {
