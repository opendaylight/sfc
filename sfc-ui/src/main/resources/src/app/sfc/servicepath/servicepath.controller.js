define(['app/sfc/sfc.module'], function (sfc) {
  ...
  sfc.register.controller('servicePathCtrl', function ($scope, $rootScope, ServiceFunctionSvc, ServicePathSvc, ModalDeleteSvc, ngTableParams, $filter, $timeout) {
    var NgTableParams = ngTableParams;

    $timeout(function() {
      $rootScope.$watch('sfps', function (newVal, oldVal) {
