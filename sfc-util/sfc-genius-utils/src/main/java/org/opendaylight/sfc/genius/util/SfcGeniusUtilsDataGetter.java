...
final class SfcGeniusUtilsDataGetter {
     ...
     *
     * @param ifName
     *            the name of the Neutron interface
     * @return the Interface object from the config DS
     */
    private static Optional<org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
        .interfaces.rev140508.interfaces.Interface> getServiceFunctionAttachedInterface(String ifName) {
        org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.interfaces.rev140508
            .interfaces.InterfaceKey ifKey = new org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
            .interfaces.rev140508.interfaces.InterfaceKey(ifName);

        InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
            .interfaces.rev140508.interfaces.Interface> ifConfigIID = InstanceIdentifier
                .create(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
                        .interfaces.rev140508.Interfaces.class)
                .child(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
                        .interfaces.rev140508.interfaces.Interface.class,
                        ifKey);
    ...
    public static Optional<Interface> getServiceFunctionAttachedInterfaceState(String ifName) {
        InstanceIdentifier<Interface> targetInterfaceIID = InstanceIdentifier.create(InterfacesState.class)
                .child(Interface.class, new InterfaceKey(ifName));
        return Optional
                .ofNullable(SfcDataStoreAPI.readTransactionAPI(targetInterfaceIID, LogicalDatastoreType.OPERATIONAL));
    }

    /**
     * Fetch the BridgeRef object from GENIUS OPERATIONAL DS, when given its
     * DpnId.
     *
     * @param theDpnId
    ...
    public static Optional<BridgeRefEntry> getBridgeFromDpnId(Uint64 theDpnId) {
        ...
        return Optional
                .ofNullable(SfcDataStoreAPI.readTransactionAPI(theBridgeRefIID, LogicalDatastoreType.OPERATIONAL));
    }

    /**
     * Read the InterfaceExternalIds of a particular ovsDB node, and
     * TerminationPoint.
     *
     * @param ovsdbNodeId
     *            the id of the ovsDB node
     * @param portName
     *            the name of the TerminationPoint
     * @return the list of externalIds of that particular TerminationPoint &
     *         ovsDB node
     */
