...
public class SfcOpenflowUtilsTest {
    ...
    private static final Integer[] randNumArray = new Integer[TOTAL_PATTERNS_GENERATED_FOR_TEST_CREATE_ACTIONS];
    private static final Integer[] randVlanArray = new Integer[6];
    ...
    private static Object[] createActionSetDlBadParams() {
        ...
        for (int i = 5; i < generatedInput.length; i++) {
            ...
            generatedInput[i] = new Object[] {cleaned, randNumArray[5]};
        }
