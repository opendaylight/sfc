...
public class SfcOpenflowUtils {
    ...
    private static void addMatchSrcIpv4(MatchBuilder match, Ipv4Prefix srcIp) {
    ...
    private static void addMatchDstIpv4(MatchBuilder match, Ipv4Prefix dstIp) {
        Ipv4MatchBuilder ipv4match = new Ipv4MatchBuilder();
    ...
    private static void addMatchSrcIpv6(MatchBuilder match, Ipv6Prefix srcIp) {
    ...
    private static void addMatchDstIpv6(MatchBuilder match, Ipv6Prefix dstIp) {
        Ipv6MatchBuilder ipv6match = new Ipv6MatchBuilder();
    ...
    private static org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action nxMoveRegAction(
        ...
        NxRegMove r = new NxRegMoveBuilder()
            ...
            .setDst(new org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.nx.action.reg.move.grouping.nx.reg.move.DstBuilder()
                .setDstChoice(dstChoice).setStart(Integer.valueOf(0)).setEnd(Integer.valueOf(endOffset)).build())
            .build();
    ...
    public static Action createActionNxMoveNsi(int order) {
        ...
        ab.setAction(nxMoveRegAction(new SrcNxNsiCaseBuilder().setNxNsiDst(Boolean.TRUE).build(),
                new DstNxNsiCaseBuilder().setNxNsiDst(Boolean.TRUE).build(), 7, // Service Index is
                                                                                // 8 bits, moving
                                                                                // bits 0-7
                false));
    ...
    public static Action createActionNxMoveNsp(int order) {
        ...
        ab.setAction(nxMoveRegAction(new SrcNxNspCaseBuilder().setNxNspDst(Boolean.TRUE).build(),
                new DstNxNspCaseBuilder().setNxNspDst(Boolean.TRUE).build(), 23, // Service Index is
                                                                                 // 24 bits, moving
                                                                                 // bits 0-23
                false));
