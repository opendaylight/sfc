...
import org.opendaylight.sfc.sfc_verify.provider.api.SfcVerifyNodeManager;
...
public class SfcVerify {
    ...
    private static final String SFCV_STR = "ioam-scv";
    ...
    public SfcVerify(DataBroker dataBroker,
        ...
        nodeManager = new SfcVerifyNodeManager(dataBroker, bindingAwareBroker, SFCV_STR);
        nodeListener = new SfcVerifyNodeListener(dataBroker, nodeManager, SFCV_STR);

        //Register as consumer for sending down configurations to SB nodes.
        final SfcVerifyNetconfDataProvider sfcVerifyNetconfDataProvider =
                                        SfcVerifyNetconfDataProvider.getNetconfDataProvider();
        ...
        //configurations.
        sfcVerifyRspProcessor = new SfcVerifyRspProcessor(dataBroker);

        sfcVerificationIoamAPI = new SfcVerificationIoamAPI(nodeManager);
