...
public class SfcVerifyIoamAPI {
    ...
    private ScvProfiles buildProfile(String name, String acl, String rspName, PolyParameters params,
        ...
        for (long j = startIndex; ;) {
            ...
            builder.setServiceProfileIndex(new Long(j))
        ...
        sbuilder.setServiceChainPathName(rspName)
                .setScvProfileStartIndex(new Long(startIndex))
                .setScvProfileNumProfiles(numProfiles)
