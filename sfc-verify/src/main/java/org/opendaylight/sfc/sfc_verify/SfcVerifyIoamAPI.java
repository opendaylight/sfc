...
public class SfcVerifyIoamAPI {
    ...
    private static SfcVerifyIoamAPI api = null;
    ...
    public static SfcVerifyIoamAPI getSfcVerifyIoamAPI() {
        ...
        synchronized (SfcVerifyIoamAPI.class) {
            if (api != null) {
                return api;
            }
    ...
    private ScvProfiles buildProfile(String name, String acl, String rspName, PolyParameters params,
        ...
        long stIndex = startIndex;
        long count = 1;
        Long maskval = new Long(SB_BITMASK_VALUE);
        ...
        for (long j = startIndex; ;) {
            ...
            builder.setServiceProfileIndex(new ProfileIndexRange(new Long(j)))
                   .setServiceProfileName(new String(name +"-Idx-"+j))
                   .setAclName(acl)
                   ...
                   .setMark(new Integer(SB_MARK_VALUE))
        ...
        sbuilder.setRenderedServicePathName(new RspName(rspName))
                .setScvProfileStartIndex(new ProfileIndexRange(new Long(startIndex)))
                .setScvProfileNumProfiles(new ProfileNumRange(new Long(numProfiles)))
    ...
    public void processRspUpdate(RenderedServicePath rsp) {
        ...
        if (hopList != null) {
            for (RenderedServicePathHop h : hopList) {
                ...
                if (sclSffs.contains(h.getServiceFunctionForwarder())) {
