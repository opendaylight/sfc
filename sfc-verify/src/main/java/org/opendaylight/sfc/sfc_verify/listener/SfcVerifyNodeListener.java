...
public class SfcVerifyNodeListener implements DataTreeChangeListener<Node> {
    ...
    public SfcVerifyNodeListener(DataBroker dataBroker, SfcVerifyNodeManager nodeManager, String sfcvStr) {
    ...
    private boolean isIoamSfcvCapableNetconfDevice(Node node) {
        ...
        if (capabilities.contains(QName.create(ScvProfiles.QNAME, sfcvStr).toString())) {
