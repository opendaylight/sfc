...
public class SfcVerifyRpc implements ServiceFunctionChainVerificationService {
    ...
    public Future<RpcResult<EnableSfcVerifyRenderedPathOutput>> enableSfcVerifyRenderedPath(
        ...
        if (ret) {
            EnableSfcVerifyRenderedPathOutputBuilder enableSfcVerifyRenderedPathOutputBuilder =
                                                     new EnableSfcVerifyRenderedPathOutputBuilder();
            ...
            String message = "Error enabling SFC verification for Rendered Service Path: " +
                              input.getSfcVerifyRspName();
            rpcResultBuilder =
                    RpcResultBuilder.<EnableSfcVerifyRenderedPathOutput>failed().withError(ErrorType.APPLICATION,
                                                                                           message);
        }
    ...
    public Future<RpcResult<DisableSfcVerifyRenderedPathOutput>> disableSfcVerifyRenderedPath(
        ...
        if (ret) {
            DisableSfcVerifyRenderedPathOutputBuilder disableSfcVerifyRenderedPathOutputBuilder =
                                                      new DisableSfcVerifyRenderedPathOutputBuilder();
            ...
            String message = "Error disabling SFC verification for Rendered Service Path: " +
                              input.getSfcVerifyRspName();
            rpcResultBuilder =
                    RpcResultBuilder.<DisableSfcVerifyRenderedPathOutput>failed().withError(ErrorType.APPLICATION,
                                                                                            message);
        }
