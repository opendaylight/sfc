...
public class SfcVerifyRspProcessor {
    ...
    public static boolean enableSfcVerification(RspName rspName,
        ...
        //Currently using default PolyAlg.class.
        sfcvAlgorithm = null;

        SfcVerificationAPI verificationAPI = SfcVerificationAPI.getAPI(sfcvAlgorithm);
        if (verificationAPI == null) {
            LOG.error("enableSfcVerification:Verfication algorithm {} not supported.", sfcvAlgorithm.getSimpleName());
            return false;
        }
        ...
        /* remove the existing augmentation */                                                                                                            renderedServicePathBuilder.removeAugmentation(RspSfcvAugmentation.class);
