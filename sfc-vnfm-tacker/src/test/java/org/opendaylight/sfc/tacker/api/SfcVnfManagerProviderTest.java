...
public class SfcVnfManagerProviderTest extends JerseyTest {
    ...
    private static final String BASE_URI = "http://localhost:8080/tackerserver/";
    ...
    public static void setUpClass() {
        ...
        tackerResponse =
                new TackerResponse.TackerResponseBuilder().setVnf(new Vnf.VnfBuilder().setStatus("PENDING_CREATE")
                    .setName("")
                    ...
                    .setMgmt_url(null)
                    .setAttributes(new Attributes.AtributesBuilder().setService_type("firewall")
    ...
    public void createSfTestAuthFail() {
        SfcVnfManagerProvider sfcVnfManagerProvider =
                new SfcVnfManagerProvider.SfcVnfManagerProviderBuilder().setBaseUri(BASE_URI)
                    .setAuth(new Auth.AuthBuilder().setTenantName("admin")
    ...
    public static class tackerServer {
        ...
        public Response postVnf(String json) {
            ...
            if (!(testRequest.auth.passwordCredentials.username.equals("admin")
                    || testRequest.auth.passwordCredentials.password.equals("devstack"))) {
                return Response.status(Response.Status.UNAUTHORIZED).entity("unauthorized").build();
            } else if (testRequest.vnf.name.isEmpty()) {
                return Response.status(Response.Status.BAD_REQUEST).entity("bad-request").build();
            }
            vnfs.add(testRequest.vnf.name);
