...
//        }
            ...
            if (matches.getAceType() instanceof AceIp) {
                ...
                if (srcDst != null) {
                    ...
                    if (lastHop !=null) {
                        ...
                        // ... build an elp with the found locator as last hop and register it with lfm.
    ...
    private IpAddress findLastHop(LispAddressContainer eid) {
        ...
        for (LocatorRecord locator : etlr.getLocatorRecord()) {
            ...
            if (address instanceof Ipv4) {
                ...
                LOG.debug("Locator address type not supported for ELP: {}", address);
            }
        }
        return null;
    }
    ...
    private void buildAndRegisterMapping(LcafSourceDest eid, List<IpAddress> hopList) {
        LispAddressContainer locatorPath = LispUtil.asLispContainer(LispUtil.buildElp(hopList));
