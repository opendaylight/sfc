...
public class SfcL2ProviderUtils extends SfcL2BaseProviderUtils {
     ...
     */
    @Override
    public Long getPortNumberFromName(final String sffName, final String portName) {

        ServiceFunctionForwarder sff = getServiceFunctionForwarder(new SffName(sffName), (long) 0);
