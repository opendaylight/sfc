...
public abstract class SfcRspTransportProcessorBase {
    ...
    public abstract void configureSffPathMapperFlow(SffGraph.SffGraphEntry entry);
    public abstract void configureNextHopFlow(SffGraph.SffGraphEntry entry);
    public abstract void configureSfTransportEgressFlow(SffGraph.SffGraphEntry entry);
    public abstract void configureSffTransportEgressFlow(SffGraph.SffGraphEntry entry);
