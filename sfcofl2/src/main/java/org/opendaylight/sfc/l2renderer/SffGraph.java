...
public class SffGraph {
    ...
    public class SffGraphEntry {
        ...
        public String getSrcSff() {
            return srcSff;
        }

        public String getDstSff() {
            return dstSff;
        }
        ...
        public void setPrevSf(String prevSf) {
            this.prevSf = prevSf;
        }

        public SffGraphEntry(final String srcSff, final String dstSff, final String sf, final String sfg, long pathId,
                short serviceIndex) {
            this.srcSff = srcSff;
            this.dstSff = dstSff;
            this.sf = sf;
    ...
    public SffGraphEntry addGraphEntry(final String srcSff, final String dstSff, final String sf, final String sfg,
