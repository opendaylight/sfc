 ...
 */
//
// TODO implement SfcL2FlowProgrammerInterface and move to OpenFlow sub-package/directory
//
public class SfcL2FlowProgrammerOFimpl implements SfcL2FlowProgrammerInterface {
    ...
    private static final BigInteger METADATA_BASE_MASK = new BigInteger("FFFFFFFFFFFFFFFF", COOKIE_BIGINT_HEX_RADIX);
