...
public class SfcL2FlowProgrammerOFimpl implements SfcL2FlowProgrammerInterface {
    ...
    public void configureTransportIngressTableMatchAny(final String sffNodeName) {
        // Notice: these flows always go to table 0, even if using App Coexistence
        FlowBuilder flowBuilder =
                configureTableMatchAnyDropFlow(TABLE_INDEX_TRANSPORT_INGRESS);
        sfcL2FlowWriter.writeFlowToConfig(flowRspId, sffNodeName, flowBuilder);
    }
    ...
    public void configureVxlanGpeTransportIngressFlow(final String sffNodeName) {
        ...
        SfcOpenflowUtils.addMatchDstUdpPort(match, 4789);
    ...
    public void configureVlanTransportEgressFlow(final String sffNodeName, final String srcMac, final String dstMac,
        ...
        FlowBuilder transportEgressFlow =
                configureTransportEgressFlow(match, actionList, switchPort, order, pathId, srcMac, dstMac);
        sfcL2FlowWriter.writeFlowToConfig(flowRspId, sffNodeName, transportEgressFlow);
    }
    ...
    public void configureVxlanGpeLastHopTransportEgressFlow(final String sffNodeName, final long nshNsp, final short nshNsi,
        ...
        FlowBuilder transportEgressFlow =
                configureTransportEgressFlow(match, actionList, switchPort, order);
        sfcL2FlowWriter.writeFlowToConfig(flowRspId, sffNodeName, transportEgressFlow);
    }

    @Override
    public void configureVxlanGpeSfTransportEgressFlow(
    ...
    public void configureVxlanGpeTransportEgressFlow(final String sffNodeName, final long nshNsp, final short nshNsi,
        ...
        configureVxlanGpeSfTransportEgressFlow(sffNodeName, nshNsp, nshNsi, switchPort);
    }
    ...
    public void configureNshNscTransportEgressFlow(
        ...
        int order = 0;
        FlowBuilder transportEgressFlow =
                configureTransportEgressFlow(match, new ArrayList<Action>(), switchPort, order, FLOW_PRIORITY_TRANSPORT_EGRESS + 10);
        sfcL2FlowWriter.writeFlowToConfig(flowRspId, sffNodeName, transportEgressFlow);
    }
    ...
    private FlowBuilder configureTransportEgressFlow(MatchBuilder match, List<Action> actionList, String port, int order, int flowPriority) {
        ...
        if(port.isEmpty() && getTableEgress() > 0) {
            LOG.info("configureTransportEgressFlow APP COEXISTENCE");
            ...
            LOG.info("configureTransportEgressFlow NOOOO APP COEXISTENCE");
