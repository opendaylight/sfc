...
public class SfcL2FlowProgrammerTest {
    ...
    public SfcL2FlowProgrammerTest() {
        ...
        // The following didnt work, since it used the value of flowBuilder at the time of
        // invocation:
    ...
    public void configureVxlanGpeLastHopTransportEgressFlow() {
        ...
        assertEquals(flowBuilder.getTableId().shortValue(), SfcL2FlowProgrammerOFimpl.TABLE_INDEX_TRANSPORT_EGRESS);
        assertEquals(flowBuilder.getPriority().intValue(),
                SfcL2FlowProgrammerOFimpl.FLOW_PRIORITY_TRANSPORT_EGRESS + 1);
        checkMatchNsh(flowBuilder.build());
    ...
    public void appCoexistenceNsh() {
        ...
        checkGoToTable(curInstruction,
                (short) (SfcL2FlowProgrammerOFimpl.TABLE_INDEX_TRANSPORT_EGRESS + TABLE_BASE - 2), true);
    ...
    public void appCoexistenceMpls() {
        ...
        checkGoToTable(curInstruction, (short) (SfcL2FlowProgrammerOFimpl.TABLE_INDEX_PATH_MAPPER + TABLE_BASE - 2),
                true);
    ...
    public void appCoexistenceMatchAny() {
        ...
        assertEquals(flowBuilder.getInstructions().getInstruction().size(), 1);
        Instruction curInstruction = flowBuilder.getInstructions().getInstruction().get(0).getInstruction();
        checkGoToTable(curInstruction, (short) (SfcL2FlowProgrammerOFimpl.TABLE_INDEX_PATH_MAPPER_ACL + TABLE_BASE - 2),
                true);
